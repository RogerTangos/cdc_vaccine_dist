 ...
 */
public class ViewClinics extends javax.swing.JPanel {
    ...
    public ViewClinics(javax.swing.JPanel jp, Hospital h) {
        initComponents();
        this.h = h;
        userProcessContainer = jp;

        jLabel1.setText(h.getOrgName() + " " + h.getClass().getSimpleName()+" | Manage Clinics");
        refresh();
    }
    ...
    void refresh() {
        ...
        ArrayList<Clinic> clist = h.getClinicList();
        for (Clinic c : clist) {
            Object[] col = new Object[6];
            col[0] = c;
            col[1] = c.getPersonDirectory().getPersonList().size();
...
// TODO add your handling code here:
    AddClinic awa = new AddClinic(userProcessContainer, h);
...
// TODO add your handling code here:
    ...
    c = (Clinic) managejTable.getValueAt(selectedRow, 0);
            
    namejTextField.setText(c.getOrgName());
    staffjTextField.setText(Integer.toString(c.getPersonDirectory().getPersonList().size()));
    add1jTextField.setText(c.getLocation().getAddress1());
    add2jTextField.setText(c.getLocation().getAddress2());
    cityjTextField.setText(c.getLocation().getCity());
    statejTextField.setText(c.getLocation().getState());
    zipjTextField.setText(c.getLocation().getPostal());
    countryjTextField.setText(c.getLocation().getCountry());
