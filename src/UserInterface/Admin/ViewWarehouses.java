 ...
 */
public class ViewWarehouses extends javax.swing.JPanel {
    ...
    public ViewWarehouses(javax.swing.JPanel jp, Enterprise enterprise) {
        initComponents();
        this.enterprise = enterprise;
        userProcessContainer = jp;

        jLabel1.setText(enterprise.getOrgName() + " " + enterprise.getClass().getSimpleName()+" | Manage Warehouses");
        refresh();
    }
    ...
    void refresh() {
        ...
        ArrayList<Organization> clist = enterprise.getOrganizationList();
        for (Organization c : clist) {
            ...
            col[3] = c.getLocation().getAddress2();
    ...
    private void initComponents() {
        ...
        managejTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clinic", "# Staff", "Address 1", "Address 2", "City", "State"
            }
        ));
...
// TODO add your handling code here:
    AddWarehouse awa = new AddWarehouse(userProcessContainer, enterprise);
...
// TODO add your handling code here:
    ...
    namejTextField.setText(o.getOrgName());
    staffjTextField.setText(Integer.toString(o.getStaffDirectory().getStaffList().size()));
