 ...
 */
public class ViewProviders extends javax.swing.JPanel {
    ...
    public ViewProviders(javax.swing.JPanel jp, PHD phd) {
        initComponents();
        this.phd = phd;
        userProcessContainer = jp;

        jLabel1.setText(phd.getOrgName() + " " + phd.getClass().getSimpleName()+" | Manage Providers");
        refresh();
    }
    ...
    void refresh() {
        ...
        ArrayList<Provider> clist = phd.getProviderList();
        for (Provider c : clist) {
            Object[] col = new Object[6];
            col[0] = c;
            col[1] = c.getClass().getSimpleName();
            col[2] = c.getStaffDirectory().getStaffList().size();
    ...
    private void initComponents() {
        ...
        managejTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Provider", "Type", "# Staff", "Address 1", "City", "State"
            }
        ));
        ...
        userjButton.setText("Add User to Provider");
...
// TODO add your handling code here:
    AddProvider awa = new AddProvider(userProcessContainer, phd);
...
// TODO add your handling code here:
    ...
    p = (Provider) managejTable.getValueAt(selectedRow, 0);
            
    namejTextField.setText(p.getOrgName());
    staffjTextField.setText(Integer.toString(p.getStaffDirectory().getStaffList().size()));
    add1jTextField.setText(p.getLocation().getAddress1());
    add2jTextField.setText(p.getLocation().getAddress2());
    cityjTextField.setText(p.getLocation().getCity());
    statejTextField.setText(p.getLocation().getState());
    zipjTextField.setText(p.getLocation().getPostal());
    countryjTextField.setText(p.getLocation().getCountry());
...
// TODO add your handling code here:
    if (p != null) {
        ...
        p.setOrgName(namejTextField.getText());
...
// TODO add your handling code here:
    if (p != null) {
    Enterprise  enterprise = (Enterprise) phd;
    Enterprise newenterprise = (Enterprise) p;
