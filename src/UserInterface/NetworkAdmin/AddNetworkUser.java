 ...
 */
public class AddNetworkUser extends javax.swing.JPanel {
    ...
    public AddNetworkUser(javax.swing.JPanel jp, Enterprise enterprise, Network network) {
        initComponents();
        this.enterprise = enterprise;
        this.network = network;
        userProcessContainer = jp;

        jLabel1.setText(enterprise.getOrgName() + " " + enterprise.getClass().getSimpleName() + " | Add User to " + network.getOrgName());
        ...
        for (Person p : network.getPersonDirectory().getPersonList()) {
    ...
    private void initComponents() {
        ...
        addUserAccountjButton.setText("Add Network Admin");
...
// TODO add your handling code here:
    UserAccount tempUA = network.getUserAccountDirectory().newUserAccount();
//    enterprise.addBusinessUserAccount(tempUA); Can't get this to work. This whole global UA idea was a bad one anyway...
    ...
    tempUA.setEnterprise(network);
    tempUA.setRole(new AdminRole());
    
    System.out.println(network.getUserAccountDirectory().getUserAccountList());

    JOptionPane.showMessageDialog(null, "Admin User Account to " + network.getOrgName());
