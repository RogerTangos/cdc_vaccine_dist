 ...
 */
public class AddCDCUser extends javax.swing.JPanel {
    ...
    public AddCDCUser(javax.swing.JPanel jp, Enterprise enterprise, CDC cdc) {
        initComponents();
        this.enterprise = enterprise;
        this.cdc = cdc;
        userProcessContainer = jp;

        jLabel1.setText(enterprise.getOrgName() + " " + enterprise.getClass().getSimpleName() + " | Add User to " + cdc.getOrgName());
        ...
        for (Person p : cdc.getPersonDirectory().getPersonList()) {
    ...
    private void initComponents() {
        ...
        addUserAccountjButton.setText("Add CDC Admin");
...
// TODO add your handling code here:
    UserAccount tempUA = cdc.getUserAccountDirectory().newUserAccount();
//    enterprise.addBusinessUserAccount(tempUA); Can't get this to work. This whole global UA idea was a bad one anyway...
    ...
    tempUA.setEnterprise(cdc);
    tempUA.setRole(new AdminRole());
    
    System.out.println(cdc.getUserAccountDirectory().getUserAccountList());

    JOptionPane.showMessageDialog(null, "Admin User Account to " + cdc.getOrgName());
