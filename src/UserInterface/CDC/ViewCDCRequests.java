 ...
 */
public class ViewCDCRequests extends javax.swing.JPanel {
    ...
    public ViewCDCRequests(javax.swing.JPanel jp, Enterprise enterprise, UserAccount ua) {
        initComponents();
    ...
    void refresh() {
        ...
        Map map = (Map) enterprise.getWorkRequestList();
        ...
        for(WorkRequest c : entryRequests){
            if(c.getInvoice()==null && c.getEditorEnterprise() instanceof PHD){//we only want the work requests that have been sent by providers
                //otherwise, they were workRequests that the CDC made to request manufacture of vaccines.
                //this also excludes invoices. phew!
    ...
    void refreshRequested(){
        ...
        ArrayList<WorkRequest> clist = cdc.getRequestsPlacedList();
    ...
    private void initComponents() {
        ...
        requestjButton.setText("Request to be Shipped");
        ...
        jLabel2.setText("Requested from Distributor:");
...
// TODO add your handling code here:
    ...
    CDC cdc = (CDC) enterprise;
    cdc.newRequestPlaced(wr); // copies from the enterprise list to the CDC one.
    cdc.getDistributor().newWorkRequest(wr);//send this request on to the Distributor
//    cdc.getWorkRequestList().remove(wr);//remove the wr from the original list.
