 ...
 */
public class AddCDCVaccineManufactureRequest extends javax.swing.JPanel {
    ...
    public AddCDCVaccineManufactureRequest(javax.swing.JPanel jp, Enterprise e, UserAccount ua) {
        initComponents();
        this.e = e;
        userProcessContainer = jp;
        this.ua = ua;

        jLabel1.setText(e.getOrgName() + " " + e.getClass().getSimpleName() + " | Add Manufacture Request");
        refresh();
    }
...
// TODO add your handling code here:
    if (v != null) {
        ...
        //first, make a workrequest, put it in the list, and populate its variables
        ...
        // then we clone it, and add another WorkRequest to the manufacturer
        WorkRequest mWorkRequest = new WorkRequest();
        mWorkRequest = wr.cloneWorkRequest(wr);

        CDC cdc = (CDC) e;
        cdc.getManufacturer().newWorkRequest(mWorkRequest);
        System.out.println(cdc.getManufacturer() + " | " + cdc.getManufacturer().getWorkRequestList());

        JOptionPane.showMessageDialog(null, "Vaccine Manufacture Requested");
    } else {
